...
VALUES ('Michael Jackson', 'Thriller', 1982, 'Pop, Rock, R&B', 47.3),
       ...
       ('El Ten Eleven', 'El Ten Eleven', 2004, 'Indie Rock', 10.0),
       ('Ratatat', 'Classics', 2006, 'Electronic Rock', 10.0),
       ('Kodomo', 'Still Life', 2008, 'Electronic', 10.0),
       ('Little People', 'Mickey Mouse Operation', 2006, 'Electronic', 10.0),
       ('Joey Fehrenbach', 'Dont Wake Me', 2010, 'Electronic', 10.0),
       ('Joey Fehrenbach', 'Mellowdrama', 2006, 'Electronic', 10.0),
       ('Joey Fehrenbach', 'A Subtle Effect', 2019, 'Electronic', 10.0),
       ('The Weekend', 'After Hours', 2020, 'Hip Hop', 10.0),
       ('Blake Shelton', 'Based On A True Story', 2016, 'Country', 10.0),
       ('Sia', 'This Is Acting', 2016, 'Alternative', 10.0);